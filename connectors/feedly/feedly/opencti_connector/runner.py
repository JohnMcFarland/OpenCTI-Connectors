...
class FeedlyRunner:
    def __init__(self, helper: OpenCTIConnectorHelper, config):
        ...
        self.connector = FeedlyConnector(
            ...
            self.helper,
            marking=self.config.feedly.marking,
            confidence=self.config.feedly.confidence,
            attach_pdf=self.config.feedly.attach_pdf,
            pdf_timeout=self.config.feedly.pdf_timeout,
            pdf_render_timeout=self.config.feedly.pdf_render_timeout,
            pdf_max_mb=self.config.feedly.pdf_max_mb,
            pdf_user_agent=self.config.feedly.pdf_user_agent,
        )
